...
public class OrderSummaryActivityTest {
    ...
    public void clickSendEmailButton_SendsEmail() {
        String subject = "Freshly Brewed from TeaTime";
        String msg = "I just ordered a delicious tea from TeaTime. Next time you are craving a tea, check them out!";
        ...
        intended(allOf(
                ...
                allOf(toPackage("com.google.android.gm")), toPackage("com.android.fallback")));
    }
}